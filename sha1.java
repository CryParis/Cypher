...
public class sha1 {
    ...
    /**
     * STEP 1
     * Method to convert string into binary
     * @param word
    ...
    public static String convertToBinary(String word) {
        ...
        return binary.toString(); //GET THE TEXT IN BINARY
    ...
    public static String createMessageLength(String message, String paddedOne, int zeros, String endLength) {
        ...
        m = m.replaceAll("\\s+", "");
        int lenghtm = m.toString().length();

        int[] mArray = new int[lenghtm/32];

        for (int i = 0; i < lenghtm; i+=32) {
